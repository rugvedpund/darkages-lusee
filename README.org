* Introduction to Higher Order Singular Value Decomposition
  :PROPERTIES:
  :CUSTOM_ID: introduction-to-higher-order-singular-value-decomposition
  :END:
...
* LuSEE-Night Simulation Products
  :PROPERTIES:
  :CUSTOM_ID: lusee-night-simulation-products
  :END:

** Single Waterfall
   :PROPERTIES:
   :CUSTOM_ID: single-waterfall
   :END:
...
#+CAPTION: Waterfall of a single antenna combination [fig:waterfall]
[[file:figures/waterfall.pdf]]

** Multiple Antenna Combinations
   :PROPERTIES:
   :CUSTOM_ID: multiple-antenna-combinations
   :END:

** Turntable Rotations
   :PROPERTIES:
   :CUSTOM_ID: turntable-rotations
   :END:
